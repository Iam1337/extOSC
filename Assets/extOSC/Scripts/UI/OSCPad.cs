...
namespace extOSC.UI
{
    ...
    public class OSCPad : Selectable, IEventSystemHandler, IInitializePotentialDragHandler, IDragHandler, ICanvasElement
    {
        #region Extensions
        ...
        private void UpdateDrag(PointerEventData eventData, Camera camera)
        {
            ...
            if (_handleContainerRect == null ||
                ...
                !RectTransformUtility.ScreenPointToLocalPointInRectangle(_handleContainerRect, eventData.position, camera, out localPoint))
                return;
